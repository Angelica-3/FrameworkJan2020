...
public class Utility {
	...
	// 5- DateTimeUtility
	// 6- Assertion Lib
	// 7- Title, url with Assertion using ExplicitWait
	// 8- FluentWait- CustomWait function
	...
	public static void verifyPartialText(WebDriver driver, By byLocator, String expectedText)
	{
		...
		// Assert.assertTrue(wait.until(ExpectedConditions.textToBePresentInElement(waitForWebElement(driver,
		// byLocator), expectedText)));
	}
